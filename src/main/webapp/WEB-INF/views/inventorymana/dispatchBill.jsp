	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">发货单</h1>

						<ul id="myTab" class="nav nav-tabs">						
							<li class="active"><a href="#underway" data-toggle="tab">待发货订单</a></li>
							<li><a href="#finish" data-toggle="tab">出库记录</a></li>
						</ul>
											...
											<tr>
												...
												<td><c:if test="${ord.status ==1}">
														<a class="btn btn-outline btn-info btn-sm"
															href="<c:url value='/SM-ord/deliver/${ord.id}' />">发货</a>
													</c:if> <c:if test="${ord.status ==2}">配送中</c:if></td>
											</tr>
										</c:forEach>
									</table>
								</c:if>
								<c:if test="${empty listOrder12}">
									<p class="text-muted">无发货订单</p>
								</c:if>
							</div>
